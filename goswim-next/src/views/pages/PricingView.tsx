      ...
      <Container maxWidth="sm">
        ...
        <Box mt={3}>
          <Typography align="center" variant="subtitle1" color="textSecondary">
            Welcome to the first platform created for freelancers and agencies for showcasing and
            finding the best clinets in the market. 30% of our income goes into Whale Charity
          </Typography>
        </Box>
      </Container>
      <Box mt="160px">
