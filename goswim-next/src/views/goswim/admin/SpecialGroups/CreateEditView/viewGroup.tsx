              ...
              <Grid className={classes.gridTop} container>
                <Grid item sm={4} xs={12} className={classes.paper}>
                  <Box className={classes.profileSec}>
                    ...
                    <Typography className={classes.avatarText}>{'sample text'}</Typography>
                  </Box>
                </Grid>
                <Grid item sm={8} xs={12} className={classes.detailContainer}>
                  ...
                  <Box p={3} className={classes.userDetailWrapper}>
                    <div className={clsx(classes.fieldDiv, classes.colored)}>
                      <p>Group Name</p>
                      <div className={classes.groupDetailStyling}>{}</div>
                    </div>
                    ...
                    <div className={clsx(classes.fieldDiv, classes.colored)}>
                      <p>Group Status</p>
                      <div className={classes.descriptionStyling}>
                        <Chip
                          color="primary"
                          variant="outlined"
                          label={'Active'}
                    ...
                    <div className={classes.description}>
                      <p>Description</p>
                      <div className={classes.descriptionStyling}>{}</div>
                    </div>
                  </Box>
                </Grid>
              </Grid>
